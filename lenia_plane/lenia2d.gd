...
func _ready() -> void:
	...
	texture_size = Vector2i(lenia_canvas.size)
	...
	var canvas_material : Material = lenia_canvas.material
	if canvas_material:
		canvas_material.set_shader_parameter("effect_texture_size", texture_size)
